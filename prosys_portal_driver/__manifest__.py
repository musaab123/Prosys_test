...

{
    ...
    'author': 'Prosys',
    'company': 'PROSYS',
    'depends': ['base', 'portal','posys_partner_extra_info','sale','account','hr','website'],
    'data': [

        'views/portal_create_customer_templates.xml',
        'views/website_thankyou_template.xml',
        'views/payment_added_successfuly.xml',
    ...
    'assets': {
     'web.assets_frontend': [
            ...
            '/prosys_portal_driver/static/src/js/payment_portal.js',
