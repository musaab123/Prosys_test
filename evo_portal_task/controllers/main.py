...
class ProjectCustomerPortal(CustomerPortal):
    ...
    def get_tasks_documents(self, task_id, **kw):
        ...
        return http.request.render('evo_portal_task.my_tasks_documents_temp_id', vals)


    # @http.route(['/my/tasks/documents/<model("ir.attachment"):task_id>'], type='http',auth="user", website=True)
    # def get_tasks_documents(self, task_id, **kw):
    #     document_object = request.env['ir.attachment']
    #     documents = document_object.search([('res_id', '=', task_id.id)])
    #     page_name = 'my_tasks_docs'
    #     vals = {'documents': documents, 'page_name': page_name, 'task_id': task_id}
    #     return request.render('evo_portal_task.my_tasks_documents_temp_id', vals)
    ...
    #     task = request.env['project.task'].search([('id', '=', int(kwargs['task_ids']))])
    #     text_content = ''
    #     if task:
    ...
    #     task.write({'customer_description': text_content})
