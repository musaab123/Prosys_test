odoo.define("setu_customer_rating.rating_dashboard", function (require) {
"use strict";
...
var RatingDashboardAction = AbstractAction.extend({
    ...
    contentTemplate: 'setu_customer_rating.RatingDashboardMain',
    jsLibs: [
...
//        this._computeControlPanelProps();
    ...
    fetch_data: function() {
        var self = this;
        var prom = this._rpc({
            route: '/setu_customer_rating/fetch_rating_dashboard_data',
            params: {
    ...
    render_dashboards: function() {
        var self = this;
        self.$('.o_rating_dashboard').append(QWeb.render('setu_customer_rating.rating_dashboard_content', {widget: self}));
    },
    ...
    _computeControlPanelProps() {
        const $searchview = $(QWeb.render("setu_customer_rating.RatingDateRangeButtons", {
            widget: this,
        }));
