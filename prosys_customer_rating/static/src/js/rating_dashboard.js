odoo.define("prosys_customer_rating.rating_dashboard", function (require) {
"use strict";
...
var RatingDashboardAction = AbstractAction.extend({
    hasControlPanel: true,
    contentTemplate: 'prosys_customer_rating.RatingDashboardMain',
    jsLibs: [
...
//        this._computeControlPanelProps();
    ...
    fetch_data: function() {
        var self = this;
        var prom = this._rpc({
            route: '/prosys_customer_rating/fetch_rating_dashboard_data',
            params: {
    ...
    render_dashboards: function() {
        var self = this;
        self.$('.o_rating_dashboard').append(QWeb.render('prosys_customer_rating.rating_dashboard_content', {widget: self}));
    },
    ...
    _computeControlPanelProps() {
        const $searchview = $(QWeb.render("prosys_customer_rating.RatingDateRangeButtons", {
            widget: this,
        }));
...
core.action_registry.add('setu_customer_rating_dashboard_client_action', RatingDashboardAction);

return RatingDashboardAction;
