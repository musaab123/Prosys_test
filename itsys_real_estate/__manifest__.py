# -*- coding: utf-8 -*-
{
    'name':'Prosys Real Estate.',
    'version':'1.0',
    'category':'Prosys Real Estate',
    'sequence':14,
    'summary':'',
    'description':""" Real Estate Management
      ...
      """,
    'author':'Prosys Technology Solutions',
    'depends':['base','account','analytic', 'web', 'hr_expense', 'sale', 'product', 'hr_expense'],
    'data':[
        ...
        'views/ac_service.xml',
        'views/building.xml',
        'views/building_services.xml',
        'views/contract_cancel_view.xml',
        ...
        'report/templates/rental_contract_custom.xml',
