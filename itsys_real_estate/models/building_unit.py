...
class building_unit(models.Model):
    ...
    north= fields.Char('Northern interface:')
    south= fields.Char('Southern interface:')
    east= fields.Char('Eastern interface:')
    west= fields.Char('Western interface:')
...
class FloorPlans(models.Model):
    ...
    product_variant_id = fields.Many2one('product.product', "Product Variant", ondelete='cascade')
