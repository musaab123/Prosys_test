...
class res_partner(models.Model):
    ...
    commercial_egistration_No =fields.Char("Commercial registration number")
    expiry_commercial_registration =fields.Date("Commercial registration expiry date")
    legal_agent =fields.Char("Legal agency")
    enterprise_number =fields.Char("Legal agency number")
    enterprise_name =fields.Char("Legal agency expiry date")
    ...
    agency_number = fields.Char("Enterprise name")
    agency_date = fields.Date("Enterprise number")
    amenities_id_rel = fields.One2many('amenities.test', 'amenities_id', string=' ')
    mobile =fields.Char("Mobile (Absher)")
