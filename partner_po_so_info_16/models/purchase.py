...
class PurchaseOrder(models.Model):
    ...
    lading_number = fields.Char('Lading Number')
    distributer_name =fields.Char('Distributer Name')
    distributer_car_number = fields.Char('Distributer Car Name')
    ...
    def _prepare_invoice(self):
        ...
        invoice_vals['from_city'] = self.from_city
        invoice_vals['to_city'] = self.to_city
