...
# collector_management/models/hr_employee.py
...
class AccountPaymentColloctor(models.Model):
    _inherit = 'account.payment'
    ...
    def _get_aml_default_display_name_list(self):
        ...
        """
        super(AccountPaymentColloctor, self)._get_aml_default_display_name_list()
