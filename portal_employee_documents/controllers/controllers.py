...
class PortalAttendanceKnk(CustomerPortal):
    ...
    def portal_certificate(self, **kw):
        ...
        return request.render("portal_employee_documents.portal_my_certificate_list", vals)
    ...
    def portal_certificate_form(self, employee_id , **kw):
        ...
        return request.render("portal_employee_documents.payslip_portal_template", vals)
