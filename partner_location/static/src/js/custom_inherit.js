odoo.define("partner_location.my_location_geolocation", function (require) {
    "use strict";
    ...
    $(document).on('click', '#get_partner_location_test', function() {
        ...
        function setCurrentPosition(position) {
            ...
            document.getElementById("partner_latitude_1").value= latitude;
            document.getElementById("partner_longitude_1").value= longitude;
